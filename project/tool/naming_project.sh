...
mv $ROOT_DIR/project/config/development/supervisor/layui_mvc_frame_queue_worker.conf $ROOT_DIR/project/config/development/supervisor/$1_queue_worker.conf
mv $ROOT_DIR/project/config/production/nginx/layui_mvc_frame.conf $ROOT_DIR/project/config/production/nginx/$1.conf
mv $ROOT_DIR/project/config/production/supervisor/layui_mvc_frame_queue_worker.conf $ROOT_DIR/project/config/production/supervisor/$1_queue_worker.conf
mv $ROOT_DIR/project/config/production/crontab/layui_mvc_frame $ROOT_DIR/project/config/production/crontab/$1
