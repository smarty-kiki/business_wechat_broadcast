...
sudo docker run --rm -ti -p 80:80 -p 8080:8080 -p 3306:3306 --name layui_mvc_frame \
    ...
    -v $ROOT_DIR/project/config/development/supervisor/layui_mvc_frame_queue_worker.conf:/etc/supervisor/conf.d/queue_worker.conf \
    -e 'PRJ_HOME=/var/www/layui_mvc_frame' \
    -e 'ENV=development' \
    -e 'TIMEZONE=Asia/Shanghai' \
    -e 'AFTER_START_SHELL=/var/www/layui_mvc_frame/project/tool/development/after_env_start.sh' \
